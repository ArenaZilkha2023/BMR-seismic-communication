...
The repository includes code used for the main analyses reported in the manuscript, including:

* Seismic signal processing and localization
* Spatial reconstruction of seismic amplitude fields
* Estimation of beam direction and beam width
* Analysis of signaling rate and amplitude
* Machine-learning classification of individual identity from head-drumming signals and temporal sequence features

Where applicable, scripts correspond to analyses and figures presented in the manuscript and its supplementary material.
